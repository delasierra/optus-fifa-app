...
public class FailLevelScreen extends ScreenModel {

    private var _msgTf:TextField;
    private var _bgImg:Bitmap;
    private var _background:Bitmap;

    public function FailLevelScreen() {
        super();
    }
...
//    Super methods
    ...
    override public function enable():void {
        _msgTf.text = 'You only got ' + AppController.getCurrentLevelResults() + ' questions correct';
        this.alpha = 0;
    ...
    private function addUiImage():void {
        if (!_bgImg) {
            _bgImg = new EmbedImages.FAIL_SCREEN_BG() as Bitmap;
